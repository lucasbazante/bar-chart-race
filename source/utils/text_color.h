...
/*!
 *  Set of useful functions to output colored text
 *
...
namespace Color {
    ...
    //! Multiply a string
    /*! This function multiply a given string.
     *
     *  @param str The string
     *  @param n The number of times to multiply it
     */
    inline string multiply( const string &str, unsigned int n )
    {
        ostringstream oss;
        while ( n-- )
            oss << str;
    ...
    static string UNIT = "█"; // unit for the bar
}
